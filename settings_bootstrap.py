...
GEOSERVER_URL = 'http://uruk:8081/geoserver/wms?transparent=true'
TILECACHE_URL = 'http://uruk:8080/tilecache/tilecache.py/'
...
TC_URL = 'http://tilecache.uruk/tiles/1.0.0/trees/'
